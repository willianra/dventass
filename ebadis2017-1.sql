...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2017 a las 03:38:00
...
INSERT INTO `entrega` (`planificacionid`, `paqueteid`, `fechaEntrega`, `cantidad`) VALUES
(101, 1, '2017-09-04', 1),
(102, 1, '2017-09-20', 2);
...
INSERT INTO `persona` (`personaid`, `ci`, `nombre`, `paterno`, `materno`, `direccion`, `telefono`, `email`) VALUES
(1, 4648829, 'Francisco', 'Mendez', 'Perez', 'c/ Agustin Lara Nº 69', '64957020', 'francisco@gmail.com'),
(2, 8229977, 'Martina', 'Miranda', 'Mamani', 'Av. Independecia Nº241', '62803375', 'martinamiranda@gmail.com'),
(3, 1941331, 'Sixto', 'Nuñez', 'Jimenez', 'Av. 10 de Noviembre Nº1024', '77303634', 'sixtonuñez@gmail.com'),
(4, 12839884, 'Vidal', 'Orellana', 'Arispe', 'c/Matamoros Nº310', '77938079', 'vidalorellana@hotmail.com'),
(5, 12839194, 'Eladia', 'Paz', 'Lino', 'Av. Independecia Nº1010', '69363050', 'eladiapaz@gmail.com'),
(6, 2983162, 'Jose', 'Pedraza', 'Saavedra', 'Av. Libertad Nº495', '64025549', 'josepedraza@gmail.com'),
(7, 11403335, 'Alejandro', 'Perez', 'Cruz', 'Av. Jesus Carranza Nº60', '76065647', 'alejandro@gmail.com'),
(8, 51584684, 'Jhonny', 'Vasquez', 'Ari', 'Av.Alemana 4º Anillo Nº124', '76468074', 'jhonny@gmail.com'),
(9, 9852580, 'Maria Alejandra', 'Vargas', 'Suarez', 'Av. Japon 3º Anillo Externo', '74145547', 'mariaalejandra@gmail.com'),
(10, 9851580, 'Jessica', 'Martinez', 'Alba', 'Av. Mutualista c/8  4º Anillo', '77775547', 'martinezalva@gmail.com'),
(11, 123123123, 'ronald', 'ajhuacho', 'flores', 'B/TierrasNuevas', '', 'peperlain@gmail.com');
...
INSERT INTO `sucursal` (`nroSucursal`, `nroPatronal`, `departamento`, `municipo`, `direccion`, `telefono`, `fax`) VALUES
(1, 9563, 'Santa Cruz', 'Santa Cruz', 'Avenida Trompillo N° 411 Zona: El Pari Nº115', '3587197', '527238'),
(2, 9563, 'Santa Cruz', 'Santa Cruz', 'Av. 3 Pasos Al Frente_barrio Convifag N° S/n Zona: Villa Primero De Mayo Nº3325', '3473889', NULL),
(1, 11966, 'Santa Cruz', 'Santa Cruz', 'Av. Paragua 2º Anillo c/6 Nº1871', '3475703', '3338714'),
(2, 11966, 'Santa Cruz', 'Warnes', 'c/ Ignacio Warnes Nº 23', '3992207', NULL),
(1, 13332, 'Santa Cruz', 'Santa Cruz', 'Av. Blanco Galindo Km.10.5 N° S/n Zona: PiÑami', '4260164', '4264410'),
(2, 13332, 'Santa Cruz', 'Buena Ventura', 'Las Lomas N° S/n Zona: Valle del Rosario N° 258', '77940917', NULL),
(1, 46901, 'Santa Cruz', 'Cotoca', 'c/ Paurito esquina Crnl. Savedra Nº3325', '3339093', NULL),
(2, 46901, 'Santa Cruz', 'Santa Cruz', 'AV. Cristobal Mendoza', '3369451', NULL),
(1, 132475, 'Santa Cruz', 'Cotoca', 'Av.Jose Estenssoro Zona:Villa Mercedes nº 213', '3713000', '33713065'),
(2, 132475, 'Santa Cruz', 'Santa Cruz', 'Calle Ayacucho N° 511 Zona: B/casco Viejo Nº 69', '3345150', NULL);
...
INSERT INTO `usuario` (`usuarioID`, `password`, `login`, `estado`, `tipo`) VALUES
(1, '12345678', 'francisco2017', 1, NULL),
(2, '12345678', 'martina', 1, NULL),
(3, '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', 'sixto', 0, NULL),
(6, '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', 'josepedraza', 0, NULL),
(7, '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'alejandroperez', 0, NULL),
(10, '96cae35ce8a9b0244178bf28e4966c2ce1b8385723a96a6b838858cdd6ca0a1e', 'jessicamartines', 0, NULL),
(11, '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'ron', 0, NULL);
...
ALTER TABLE `detalleproducto`
  ...
  ADD KEY `productoid` (`productoid`),
  ADD KEY `FK_DetalleProducto_Almacen` (`almacenid`),
  ADD KEY `FK_DetalleProducto_Producto` (`productoid`);
...
--
ALTER TABLE `entrega`
  ADD PRIMARY KEY (`planificacionid`,`paqueteid`),
  ADD KEY `paqueteid` (`paqueteid`),
...
ALTER TABLE `pedido`
  MODIFY `pedidoid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
--
...
--
ALTER TABLE `detalleproducto`
  ADD CONSTRAINT `DetalleProducto_Almacen` FOREIGN KEY (`almacenid`) REFERENCES `almacen` (`almacenid`),
  ADD CONSTRAINT `DetalleProducto_Producto` FOREIGN KEY (`productoid`) REFERENCES `producto` (`productoid`);
...
--
ALTER TABLE `sucursal`
  ADD CONSTRAINT `Suculsa_Empresa` FOREIGN KEY (`nroPatronal`) REFERENCES `empresa` (`nroPatronal`);

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `FK_Usuario_Tipo` FOREIGN KEY (`tipo`) REFERENCES `tipo` (`tipoid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `usuarioPersona` FOREIGN KEY (`usuarioID`) REFERENCES `persona` (`personaid`) ON DELETE CASCADE ON UPDATE CASCADE;
