              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="box-header with-border">
                          <h1 class="box-title"> Personal Empresa<button class="btn btn-success" 
                    ...
                    <!-- /.box-header -->
                    <!-- centro -->
                    <div class="panel-body table-responsive" id="listadopersonalEmpresa">
                        <table id="tbllistado" 
                        ...
                        id="formulario" method="POST">
                         ...
                         <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>personaid(*):</label>
                             <input type="hidden" name="personalsucursalid" id="personalsucursalid">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/personalempresa.js"></script>
<?php 
}
ob_end_flush();
