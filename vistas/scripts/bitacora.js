	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax": //parametro
				{//obteniedo datos por get en la variable op
					url: '../ajax/bitacora.php?op=listar',//accedi9endo
					type : "get",
					dataType : "json",						
					error: function(e){
...
function mostrar(bitacoraid)
{											//variable a enviar  valor enviado 
	$.post("../ajax/bitacora.php?op=mostrar",{bitacoraid : bitacoraid}, function(data, status)
	{
		data = JSON.parse(data);		
		mostrarform(true);

		$("#bitacoraid").val(data.bitacoraid);
