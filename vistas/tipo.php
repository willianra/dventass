              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="box-header with-border">
                          <h1 class="box-title">Tipos de cargo <button class="btn btn-success" 
                            id="btnagregar" onclick="mostrarform(true)"><i
                            class="fa fa-plus-circle"></i> Agregar una nueva tipo</button></h1>
                     ...
                     id="formularioregistros">
                        ...
                        id="formulario" method="POST">
                         ...
                         <label>Codigo:</label>
                            ...
                            <input type="number" class="form-control" name="tipoid" id="tipoid" maxlength="50" placeholder="codigo" required>
                          </div>
